...
export const shuffleByLevels = async (levels) => {
  try {
    const response = await fetch(
      `http://localhost/api/shuffle.php?levels=${levels}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchByChapter = async (chapter, level) => {
  try {
    const response = await fetch(
      `http://localhost/api/?level=${level}&chapter=${chapter}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchByLevel = async (level) => {
  try {
    const response = await fetch(
      `http://localhost/api/?level=${level}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchByMultiChapters = async (chapters, level) => {
  try {
    const response = await fetch(
      `http://localhost/api/?chapters=${chapters}&level=${level}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchBySearchValue = async (value) => {
  try {
    const response = await fetch(
      `http://localhost/api/?search=${value}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchQuiz_charOn_chapter_level = async (
  ...
  try {
    const response = await fetch(
      `http://localhost/api/quiz.php?chapter=${chapter}&level=${level}&mode=${mode}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchQuiz_charOn_level = async (level, mode = 1) => {
  try {
    const response = await fetch(
      `http://localhost/api/quiz.php?level=${level}&mode=${mode}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchQuiz_charOn_rand = async (count, mode = 1) => {
  try {
    const response = await fetch(
      `http://localhost/api/quiz.php?rand=${count}&mode=${mode}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchJukugo_byLevel = async (level = 5) => {
  try {
    const response = await fetch(
      `http://localhost/api/jukugo.php?level=${level}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchRandomJukugo_byLevel = async (count = 20, level = 3) => {
  try {
    const response = await fetch(
      `http://localhost/api/jukugo.php?level=${level}&rand=${count}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchJukugo_byKanjis = async (kanjis) => {
  try {
    const response = await fetch(
      `http://localhost/api/jukugo.php?kanjis=${kanjis}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const fetchJukugo_byLevelChapter = async (chapter, level) => {
  try {
    const response = await fetch(
      `http://localhost/api/jukugo.php?level=${level}&chapter=${chapter}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const getUserPractice = async (id, type) => {
  try {
    const response = await fetch(
      `http://localhost/api/user_practice.php?user_id=${id}&item_type=${type}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const getUserFavourite = async (id, type) => {
  try {
    const response = await fetch(
      `http://localhost/api/user_practice.php?user_id=${id}&item_type=${type}&for_favourite`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const getUserTarget = async (id, type) => {
  try {
    const response = await fetch(
      `http://localhost/api/user_practice.php?user_id=${id}&item_type=${type}&for_target`
    );
    const data = await response.json();
    return data;
  } catch (error) {
